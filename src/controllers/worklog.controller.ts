...
export const worklog = async (
    ...
    try {
        ...
        let worklogEntry = await Worklog.findOne({ userId, projectId, taskId, endTime: null });
...
export const getAllWorklogsProjectWise = async (
    req: WorklogRequest,
    res: Response,
    next: NextFunction
): Promise<void> => {
